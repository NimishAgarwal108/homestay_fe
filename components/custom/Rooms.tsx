...
const Rooms = () => {
  ...
  return (
    <section id="rooms" className="py-24 px-6 bg-[#BFC7DE]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {rooms.map((room, idx) => (
            <div key={idx} className="group relative bg-white rounded-2xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 shadow-lg">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  {room.features.map((feature, i) => (
                    <div key={i} className="flex items-center gap-1">
                      <div className="w-1.5 h-1.5 bg-[#7570BC] rounded-full"></div>
                ...
                <div className="flex items-center justify-between mt-6 pt-6 border-t border-[#BFC7DE]">
                  <div>
                    <Typography variant="h3" textColor="primary" weight="bold" as="span">
                      ₹{room.price}
                    </Typography>
                    <Typography variant="muted" textColor="secondary" as="span">
                      {" / night"}
                    </Typography>
                  </div>
                  <a href="#booking" className="bg-[#C59594] text-white px-6 py-2 rounded-full hover:bg-[#7570BC] transition-all">
                    <Typography variant="small" textColor="white" weight="semibold">
                      Book
                    </Typography>
                  </a>
