...
export default function ResetPasswordClient() {
  ...
  useEffect(() => {
    console.log('🔍 reset-password - checking sessionStorage');
    ...
    console.log('🔍 reset-password - Email from storage:', storedEmail);
    console.log('🔍 reset-password - Final email:', finalEmail);
    console.log('🔍 reset-password - Token present:', !!storedToken);
    
    // ✅ CRITICAL: Only accept resetToken from backend (NOT client-side OTP)
    if (!finalEmail || !storedToken) {
      console.log('❌ Missing email or reset token - redirecting to forgot-password');
